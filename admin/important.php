...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Các tài khoản</h1>
    ...
    <tbody>
      ...
      {
        $sel = 'select * from signup where name like "%'.$_GET['var'].'%"';
      }
      else
      {
    ...
    ?>
      <tr>
          ...
          <td> <img src="userimages/<?php echo $row['profile']; ?>" style="width:80px;"></td>
          
          


           <td><a onclick="return confirm('Bạn chắc chứ?')" href="deleteuser.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">Xóa</a></td>
