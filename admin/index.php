      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block"><img src="image/reader.png" alt="boy reading a book"></div>
              <div class="col-lg-6">
                <div class="p-5" style="margin-top:200px;">
                  ...
                  <form class="user" action="loginfetch.php" method="post">
                    <div class="form-group">
                      <input type="email" name="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Hãy nhập email ...">
                    </div>
                    <div class="form-group">
